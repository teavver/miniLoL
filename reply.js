...
export default async function reply(_data, _server, interaction, _username, _mmr) {
   ...
   const reply = endReply(_data,dataSpec,_username,shortwr,serverText, tierImgArr[dataSpec.tier],_mmr)
